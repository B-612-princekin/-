...
export default {
  ...
  watch: {
    ...
    newUrl: function () {
      // console.log(
      //   this.newUrl.substring(this.newUrl.length - 1, this.newUrl.length)
      // );
  ...
  created: function () {
    this.axios
      ...
      .then((res) => {
        // this.classifyBoyData = res.data.list[0].labels;
        this.classifyBoyData = res.data[1].cates;
